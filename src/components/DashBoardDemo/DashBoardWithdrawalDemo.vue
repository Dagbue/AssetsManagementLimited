<template>
  <div>
    <div class="body">
      ...
      <h2 class="header">Withdrawal Demo</h2>
      <div class="section-1">
...
export default {
  ...
  methods: {
    ...
    async showDialog() {
      ...
      await setDoc(doc(db, "InvestmentDemo", auth.currentUser.email), {
        withdrawal: increment(this.withdrawal),
        withdrawalmethod: this.withdrawalmethod,
        statusWithdrawal: this.statusWithdrawal,
        email: this.email
      ...
      const Deposit = ref(database, myUserId + "/WithdrawalRequestsDemo");
      ...
      const Deposit3 = ref(database, myUserId3 + "/TransactionsDemo");
      ...
      const Deposit2 = ref(database, "/WithdrawalRequestsDemo");
