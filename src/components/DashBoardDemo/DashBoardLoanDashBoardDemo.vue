<template>
  <div>
    <h1 class="header">Loan Service</h1>
      ...
      <div class="card-holder">
        <div class="card-1">
          ...
          <div class="card-content-margin">
            ...
            <!--            <p class="card-big-text" v-show="approved === 'approved'">£ {{items.loanDeposit}}</p>-->
        ...
        <div class="card-1">
          ...
          <div class="card-content-margin">
            ...
            <!--            <p class="card-big-text" v-show="approved === 'approved'">£ {{items.prepaymentFee}}</p>-->
        ...
        <div class="card-1">
          ...
          <div class="card-content-margin">
            ...
            <!--            <p class="card-big-text" v-show="approved === 'approved'">{{items.statusLoan}}</p>-->
        ...
        <div class="card-1">
          ...
          <div class="card-content-margin">
            ...
            <!--            <p class="card-big-text" v-show="approved === 'approved'">{{items.loanPlan}}</p>-->
...
export default {
  name: "DashBoardLoanDashBoardDemo",
  data () {
    return {
      contacts: [],
      approved: '',
  ...
  async created() {
    ...
    querySnapshot.forEach((doc) => {
      ...
      this.approved = doc.data().statusLoan
    })
