  ...
  <div class="outer">
    ...
    <div v-if="user" class="sidebar" v-show="!mobile">
      ...
      <ul class="nav-list" >
        ...
        <router-link to="/wallets-management-demo">
        <li>
          <a class="hover">
        ...
        <router-link to="/transactions-demo">
        <li>
          <a class="hover">
        ...
        <router-link to="/fund-wallet-demo">
        <li>
          <a class="hover">
        ...
        <router-link to="/withdrawal-demo">
        <li>
          <a class="hover">
            <img src="../../assets/coin-stack.svg" alt="logo" class="link-img" />
        ...
        <router-link to="/subscription-trade-demo">
          <li>
            <a class="hover">
        ...
        <router-link to="/refer-users-demo">
          <li>
            <a class="hover">
        ...
        <router-link to="/loan-dashboard-demo">
          <li>
            <a class="hover">
              <img src="../../assets/dashboardlogo.svg" alt="logo" class="link-img" />
...
<!--      <i class='bx bx-user'></i>-->
      ...
      <ul>
        <li @click="toggleMobileNav2">
          <a>
            <img src="@/assets/dashboardlogo.svg" alt="logo" class="link-img" />
            <router-link to="/over-view-demo" class="">DashBoard</router-link>
          </a>
        </li>
        <li @click="toggleMobileNav2">
          <a>
            <img src="../../assets/walletmana.svg" alt="logo" class="link-img" />
            <router-link to="/wallets-management-demo" class="">Wallets</router-link>
          </a>
        </li>
        <li @click="toggleMobileNav2">
          <a>
            <i class='bx bx-support' ></i>
            <router-link to="/transactions-demo" class="">Transactions</router-link>
          </a>
        </li>
        <li @click="toggleMobileNav2">
          <a>
            <img src="../../assets/coin-stack.svg" alt="logo" class="link-img" />
            <router-link to="/fund-wallet-demo" class="">Fund Wallet</router-link>
          </a>
        </li>
        <li @click="toggleMobileNav2">
          <a>
            <img src="../../assets/coin-stack.svg" alt="logo" class="link-img" />
            <router-link to="/withdrawal-demo" class="">Withdrawal</router-link>
          </a>
        </li>
        <li @click="toggleMobileNav2">
          <a>
            <img src="@/assets/pie-chart.svg" alt="logo" class="link-img" />
            <router-link to="/subscription-trade-demo" class="">Sub Trade</router-link>
          </a>
        </li>
        <li @click="toggleMobileNav2">
          <a>
            <img src="../../assets/virtacc.svg" alt="logo" class="link-img" />
            <router-link to="/refer-users-demo" class="">Refer Users</router-link>
          </a>
        </li>
        ...
        <li @click="toggleMobileNav2">
          <a>
            <img src="../../assets/walletmana.svg" alt="logo" class="link-img" />
            <router-link to="/loan-demo" class="">Loan Req</router-link>
          </a>
        </li>
        ...
        <li @click="toggleMobileNav2">
          <a>
            <img src="../../assets/settings.svg" alt="logo" class="link-img" />
            <router-link to="/settings-demo" class="">Settings</router-link>
          </a>
        </li>
...
export default {
  ...
  setup() {
    ...
    router.push('/dashboard-side-bar-demo')
    return { handleClick,
