    ...
    <div class="section-3">
      <div class="section-3-content">
        <div class="content-1">
          ...
          <p class="content-1-text-2">£ {{this.contacts.deposit}}</p>
        </div>
        <div class="content-2">
      ...
      <div class="section-3-content">
        <div class="content-1">
          ...
          <p class="content-1-text-2">£ {{this.contacts.withdrawal}}</p>
        </div>
        <div class="content-2">
      ...
      <div class="section-3-content">
        <div class="content-1">
          ...
          <p class="content-1-text-2">£ {{this.contacts.profits}}</p>
        </div>
        <div class="content-2">
          <img src="@/assets/wallet-number-icon.svg" alt="wallet-balance-icon"/>
        </div>
      ...
      <div class="section-3-content">
        <div class="content-1">
          ...
          <p class="content-1-text-2">£ {{this.contacts.bonusMain}}</p>
        </div>
        <div class="content-2">
          <img src="@/assets/wallet-number-icon.svg" alt="wallet-balance-icon"/>
        </div>
    ...
    <div class="section-3-i">
      ...
      <div class="section-3-content">
        <div class="content-1">
          ...
          <p class="content-1-text-2">£ {{this.contacts.bonus}}</p>
        </div>
        <div class="content-2">
          <img src="@/assets/wallet-balance-icon.svg" alt="wallet-balance-icon"/>
        </div>
      ...
      <div class="section-3-content">
        <div class="content-1">
          ...
          <p class="content-1-text-2">£ {{ this.contacts.deposit + this.contacts.profits + this.contacts.bonusMain + this.contacts.bonus - this.contacts.withdrawal  }} </p>
        </div>
        <div class="content-2">
          <img src="@/assets/wallet-number-icon.svg" alt="wallet-balance-icon"/>
        </div>
      ...
      <div class="section-3-content">
        <div class="content-1">
          ...
          <p class="content-1-text-2">{{this.contacts.ROI}}</p>
        </div>
        <div class="content-2">
          <img src="@/assets/wallet-number-icon.svg" alt="wallet-balance-icon"/>
        </div>
      ...
      <div class="section-3-content">
        <div class="content-1">
          ...
          <p class="content-1-text-2">{{this.contacts.selected}}</p>
        </div>
        <div class="content-2">
          <img src="@/assets/wallet-number-icon.svg" alt="wallet-balance-icon"/>
        </div>
...
export default {
  name: "DashBoardUserDashBoardViewDemo",
  data () {
    return {
      contacts: [],
    }
