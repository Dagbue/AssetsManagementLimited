<template>
  <div>
    <div class="body">
      ...
      <h2 class="header">Fund Wallet Demo</h2>
...
export default {
  ...
  methods: {
    ...
    async showDialog() {
      ...
      const Deposit = ref(database, myUserId + "/DepositRequestsDemo");
      ...
      const Deposit2 = ref(database, "/DepositRequestsDemo");
